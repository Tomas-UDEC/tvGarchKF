#' @title LS-TvGarch Filter Kalman print outputs.
#' @description That function it is for print outputs of tvGarch model
#' who contains the returns, variance conditional, value of log likelihood, and MSE.
...
#' @export
LSgarchKalmanPrint <- function(x, series, c, alpha, beta, nsample=length(series), type=c("polynomial","NoLineal","trigonometric"), exponentes, trig, arg, trace.log=F, predict){
